...
const STRINGS = {
  en: {
    ...
    navMeta: 'Ten topics &middot; Fifty one items',
    eyebrow: 'A field manual',
    welcomeTitle: 'A practical reference for <em>AI delivery</em> work',
    welcomeSubtitle: 'Definitions, decision points, watch outs, and stories from the field. Fifty one items across ten topics.',
  ...
  zh: {
    brandLine1: 'AI \u4ea4\u4ed8',
    brandLine2: '\u77e5\u8bc6\u5e93',
    navMeta: '\u5341\u4e2a\u4e3b\u9898 &middot; \u4e94\u5341\u4e00\u4e2a\u6761\u76ee',
    eyebrow: '\u4e00\u672c\u73b0\u573a\u624b\u518c',
    welcomeTitle: '\u4e00\u4efd\u5173\u4e8e <em>AI \u4ea4\u4ed8</em> \u5de5\u4f5c\u7684\u5b9e\u7528\u53c2\u8003',
    welcomeSubtitle: '\u5b9a\u4e49\u3001\u51b3\u7b56\u70b9\u3001\u6ce8\u610f\u4e8b\u9879,\u4ee5\u53ca\u6765\u81ea\u73b0\u573a\u7684\u6848\u4f8b\u3002\u5341\u4e2a\u4e3b\u9898,\u4e94\u5341\u4e00\u4e2a\u6761\u76ee\u3002',
...
function renderSidebar() {
  ...
  document.getElementById('navMeta').innerHTML = getStr('navMeta');
...
function renderWelcome() {
  ...
  w.innerHTML = `
    ...
    <p class="welcome-subtitle">${getStr('welcomeSubtitle')}</p>
